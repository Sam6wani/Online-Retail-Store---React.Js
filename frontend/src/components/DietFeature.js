            ...
            <FormControl>
              <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={10}>
                <Box>
                  ...
                  />
                  <FormLabel>Gender</FormLabel>
                  <Select name="gender" onChange={handleChange}   value={userInfo.gender}>
                    <option value="" disabled>
                      Select an option
                    </option>
                    <option value="Man">Male</option>
                  ...
                  <FormLabel>Activity Level</FormLabel>
                  <Select name="activityLevel" onChange={handleChange} value={userInfo.activityLevel}>
                    <option value="" disabled>
                      Select an option
                    </option>
                    <option value="Sedentary">
                ...
                <Box>
                  <FormLabel>Health Goals</FormLabel>
                  <Select name="healthGoals" onChange={handleChange} value={userInfo.healthGoals}>
                    <option value="" disabled>
                      Select an option
                    </option>
                    <option value="lose weight">Lose weight</option>
